...
- herencia -- existen clases que tiene como super clase (sub variedad)
...
“El punto era ayudar a los estudiantes a sentirse empoderados para entender y crear con computadoras, lo diametralmente opuesto a adoptar una postura pasiva y llena de asombro.” (Emerson, 2014, p. 20, )  
Cita 2:

“A pesar de esta notable gama de restricciones tanto en la forma como en el contenido de la expresión creativa en el iPad, en un puñado de aplicaciones de literatura digital todavía hay una conexión clara entre Videoplace y el intento de explorar y expresar el medio como un medio a través del juego abierto, el tacto, el movimiento encarnado y el cortejo a lo no familiar.” (Emerson, 2014,  p. 25)

**páginas leidas:** 20 a la 27

> 💭 **reflexión sobre la lectura**
> en estas páginas la autora habla sobre el trabajo pionero de Myron Krueger con videoplace y cómo buscaba que las pantallas táctiles y la realidad aumentada sirvieran para experimentar y crear arte de forma libre y abierta, no solo para hacer tareas rápido. en general, muestra cómo estos creadores aprovechan la pantalla táctil para jugar con las palabras y las letras como si fueran objetos vivos. 
